...
const verifing = (type) => {
    if (type === "pairing") {
        console.log(chalk.magenta.bold(`\n\n ‎ ‎  OblivionX MD • coppyright©2025 - zuu `));
...
const connectted = async (zuu) => {
  const cxdf = JSON.stringify(zuu.user, null, 2);
  ...
  setTimeout(async() => {
    ...
    console.log(chalk.magentaBright.bold(` ‎ ‎ OblivionX - MD • coppyright©2025 - zuu`));
    console.log(chalk.white(' ‎ ‎_____________________________________\n'));
